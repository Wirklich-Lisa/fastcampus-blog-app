...
export default function LoginForm() {
    ...
    const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if(name === 'email') {
            ...
            if(value?.length < 8) {
                ...
                setError("비밀번호와 비밀번호 확인값이 다릅니다. 다시 확인 해 주세요");
            }else {
                setError("");
            }
            ...
            if(value?.length < 8) {
                ...
                setError("비밀번호와 값이 다릅니다. 다시 확인 해 주세요");
            }else {
                setError("");
            }
        }
    ...
    <form onSubmit={onSubmit} className="form form--lg">
        ...
        <div className="form__block">
            <input type="submit" value="signup" className="form__btn--submit" disabled={error?.length > 0 }/>
        </div>
    </form>
    )
}
